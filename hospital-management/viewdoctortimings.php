...
if(isset($_GET[delid]))
{
	...
	{
		echo "<script>alert('registro de doctortimings eliminado con éxito..');</script>";
	}
}
?>
<div class="container-fluid">
  <div class="block-header">
    <h2 class="text-center">Ver horarios de doctor</h2>
    ...
    <table class="table table-bordered table-striped table-hover js-exportable dataTable" >
      ...
      <tbody>
        ...
        echo "<tr>
          ...
          <td>&nbsp;$rs[status]</td>
          <td width='250'>&nbsp;<a href='doctortimings.php?editid=$rs[doctor_timings_id]' class='btn btn-raised btn-sm g-bg-cyan'>Edit</a>  <a href='viewdoctortimings.php?delid=$rs[doctor_timings_id]' class='btn btn-raised btn-sm g-bg-blush2'>Eliminar</a> </td>
        </tr>";
		}
		?>
