...
if(isset($_POST[submit]))
{
		if(isset($_GET[editid]))
		{
			...
			{
				echo "<script>alert('registro de cita actualizado con éxito...');</script>";
			}
			else
			{
...
<div class="toggle">
	<!-- Toggle Link -->
	<a href="#" title="Title of Toggle" class="toggle-trigger">Perfil paciente</a>
...
<div class="toggle">
	<!-- Toggle Link -->
	<a href="#" title="Title of Toggle" class="toggle-trigger">Registro de citas</a>
	<!-- Toggle Content to display -->
	<div class="toggle-content">
...
<div class="toggle">
	<!-- Toggle Link -->
	<a href="#" title="Title of Toggle" class="toggle-trigger">Registro de recetas</a>
	<!-- Toggle Content to display -->
	<div class="toggle-content">
		<p><?php
...
<div class="toggle">
	<!-- Toggle Link -->
	<a href="#" title="Title of Toggle" class="toggle-trigger">Registro de ingresos</a>
	<!-- Toggle Content to display -->
	<div class="toggle-content">
		<p><?php
...
?>
	...
	$rsbilling_records = mysqli_fetch_array($qsqlbilling_records);
				  ...
				  <a class="btn btn-raised" href="paymentdischarge.php?appointmentid=<?php echo $rsappointment[0]; ?>&patientid=<?php echo $_GET[patientid]; ?>">Hacer pago</a>
