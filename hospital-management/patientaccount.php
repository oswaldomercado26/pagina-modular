            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#profile_animation_1"
                            aria-expanded="false">Citas</a></li>
                ...
                <div class="tab-content" style="padding: 10px">
                    <div role="tabpanel" class="tab-pane animated flipInX active" id="home_animation_1"
                        ...
                        <h3>Estas con nosotros de <?php echo $rspatient[admissiondate]; ?>
                    ...
                    <div role="tabpanel" class="tab-pane animated flipInX" id="profile_animation_1"
                        ...
                        {
                            ?>
                        <h3>No se encontraron registros de citas.. </h3>
                        <?php
                        }
                        else
                        {
                            ?>
                        <h3>Última cita contratada - <?php echo $rspatientappointment[appointmentdate]; ?>
