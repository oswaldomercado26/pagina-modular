...
if(isset($_POST[submit]))
{
	if(isset($_SESSION[doctorid]))
	{
		...
		{
			echo "<script>alert('Perfil médico actualizado con éxito...');</script>";
		}
		else
		{
...
<div class="container-fluid">
    <div class="block-header">
        <h2 class="text-center"> Perfil Doctor</h2>
    </div>
                ...
                <form method="post" action="" name="frmdoctprfl" onSubmit="return validateform()" style="padding: 10px">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-xs-12">
                            ...
                            <input class="btn btn-raised" type="submit" name="submit" id="submit" value="Enviar" />
                        </div>
                    </div>
...
function validateform() {
    if (document.frmdoctprfl.doctorname.value == "") {
        ...
        alert("El nombre del médico no es válido..");
        document.frmdoctprfl.doctorname.focus();
        return false;
