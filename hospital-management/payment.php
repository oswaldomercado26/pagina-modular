...
if(isset($_POST[submit]))
{
		...
		{
			echo "<script>alert('registro de pago insertado correctamente...');</script>";
		}
		else
		{
...
<div class="wrapper col2">
  <div id="breadcrumb">
    <ul>
      <li class="first">Detalles de pago</li></ul>
  </div>
</div>
<div class="wrapper col4">
  <div id="container">
    ...
    <table width="515" border="3">
     <thead>
        <tr>
          <th colspan="2">&nbsp;Agregar detalles de pago.. </th>
          </tr>
          </thead>
           <tbody>
        <tr>
          <td width="34%">Fecha de pago</td>
