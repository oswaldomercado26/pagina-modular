...
if(isset($_GET[delid]))
{
	...
	{
		echo "<script>alert('registro de facturación eliminado correctamente..');</script>";
	}
}
?>
...
?>
 	<table class="table table-bordered table-striped">
      <tbody>
        ...
        <tr>
          <th width="124" scope="col"><div align="right">Numero de cita &nbsp; </div></th>
          	<td width="413"> <?php echo $rsbilling_records[appointmentid]; ?>
            </td>
        </tr>
         
		<tr>
		  <th scope="col"><div align="right">Fecha de factura &nbsp; </div></th>
		  <td>&nbsp;<?php echo $rsbilling_records[billingdate]; ?></td>
	    </tr>
        
		<tr>
		  <th scope="col"><div align="right">Hora de factura&nbsp; </div></th>
	...
	<table class="table table-bordered table-striped">
      <thead>
       <tr>
          ...
          <th width="245" scope="col">Decripcion</th>
...
if($rs[bill_type]  == "Prescription charge")
{
    ...
    <table class="table table-bordered table-striped">
      <tbody>
        ...
        <tr>
          <th width="442" scope="col"><div align="right">Importe del impuesto (5%) &nbsp; </div></th>
