 ...
 <table class="table table-bordered table-striped">
      <tbody>
        <tr>
          ...
          <td><strong>Fecha preinscripcion</strong></td>
...
<form method="post" action="" name="frmpresrecord" onSubmit="return validateform()"> 
  <input type="hidden" name="prescriptionid" value="<?php echo $_GET[prescriptionid]; ?>"  />
    <table class="table table-striped">
      <tbody>
        ...
        <tr>
		  ...
		  <option value="">Selecionar Medicina</option>
		  <?php
	...
	<table>
	<tr><td>
	 <center><a href='patientreport.php?patientid=<?php echo $_GET[patientid]; ?>&appointmentid=<?php echo $_GET[appid]; ?>'><strong>Ver informe del paciente>></strong></a></center>
	</td></tr>
	</table>
<script>
function myFunction() {
