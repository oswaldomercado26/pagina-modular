...
if(isset($_POST[submit]))
{
	...
	if(isset($_GET[editid]))
	{
		...
		{
			echo "<script>alert('registro de tratamiento actualizado con éxito...');</script>";
		}
		else
		{
	...
	else
	{
		...
		{
			echo "<script>alert('Registro de tratamiento insertado correctamente...');</script>";
		}
...
?>			
        ...
        <tr>
          <td>Hora de tratamiento</td>
          <td><input class="form-control" type="time" name="treatmenttime" id="treatmenttime" value="<?php echo $rsedit[treatment_time]; ?>" /></td>
        </tr>

        <tr>
          <td colspan="2" align="center"><input class="form-control" type="submit" name="submit" id="submit" value="Submit" /> | <a href='patientreport.php?patientid=<?php echo $_GET[patientid]; ?>&appointmentid=<?php echo $_GET[appid]; ?>'><strong>Ver informe del paciente>></strong></a></td>
        </tr>
      </tbody>
    </table>
    </form>
    <p>&nbsp;</p>
        ...
        <tbody>
          <tr>
            ...
            <td width="82">Descripcioon de tratamiento</td>
            <td width="103">Subidas</td>
            <td width="43">Fecha de tratamiento</td>
            <td width="43">Hora de tratamiento</td>
            <td width="54">Estatus</td>
            <td width="58">Accion</td>
          </tr>
          <?php
...
function validateform()
{
	...
	{
		alert("El ID de la cita no debe estar vacía..");
	...
	{
		alert("El ID de tratamiento no debe estar vacío..");
	...
	{
		alert("El ID del médico no debe estar vacía..");
	...
	{
		alert("La fecha de tratamiento no debe estar vacía..");
