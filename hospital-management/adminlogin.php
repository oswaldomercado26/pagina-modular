...
{	
	...
	else
	{
		...
		<strong>Oh !</strong> Cambie algunas cosas e intente enviar de nuevo.
	</div>";
	}
}
...
?></div>
    ...
    <div class="card">
        <h1 class="title"><span>AgileMed</span>Login <span class="msg">Regístrese para iniciar su sesión</span></h1>
        <div class="col-md-12">
    ...
    <div class="input-group"> <span class="input-group-addon"> <i class="zmdi zmdi-account"></i> </span>
                ...
                <div>
                    ...
                    <div class="text-center"> <a href="forgot-password.html">Recuperar Password?</a></div>
                </div>
            </form>
        </div>
    </div>    
...
function validateform()
{
	...
	{
		document.getElementById("err").innerHTML ="<div class='alert alert-info'><strong>Heads up!</strong> Por favor Ingrese Contraseña</div>";
		document.frmadminlogin.loginid.focus();
		return false;
	}
	else if(!document.frmadminlogin.loginid.value.match(alphanumericExp))
	{
		document.getElementById("err").innerHTML ="<div class='alert alert-Warning'><strong>Heads up!</strong> Contraseña Invalida</div>";
		document.frmadminlogin.loginid.focus();
		return false;
	}
	else if(document.frmadminlogin.password.value == "")
	{
		document.getElementById("err").innerHTML ="<div class='alert alert-info'><strong>Heads up!</strong> No debe estar vacío</div>";
		document.frmadminlogin.password.focus();
		return false;
	}
	else if(document.frmadminlogin.password.value.length < 8)
	{
		document.getElementById("err").innerHTML ="<div class='alert alert-info'><strong>Heads up!</strong> La longitud debe ser 8</div>";
		document.frmadminlogin.password.focus();
		return false;
	}
	else
