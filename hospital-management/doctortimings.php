...
if(isset($_POST[submit]))
{
	if(isset($_GET[editid]))
	{
		...
		{
			echo "<script>alert('Registro de tiempos de médico actualizado con éxito...');</script>";
		}
		else
		{
	...
	if($qsql = mysqli_query($con,$sql))
	{
		echo "<script>alert('Registro de tiempos de doctor insertado correctamente...');</script>";
	}
	else
	{
		echo mysqli_error($con);
...
<div class="container-fluid">
	<div class="block-header">
            <h2 class="text-center">Agregar nuevos tiempos de doctor</h2>
